    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] p-4 relative overflow-hidden">
      ...
      <div className="absolute top-8 right-8 z-50" ref={langRef}>
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--card)] backdrop-blur-md border border-[var(--border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] hover:bg-[var(--muted)] transition-all shadow-xl"
        >
          ...
          >
            {languages.map((lang) => (
              ...
              >
                ...
                {i18n.language === lang.code && (
                  <div className="ml-auto w-2 h-2 rounded-full bg-[var(--foreground)] shadow-[0_0_10px_var(--foreground)]" />
                )}
              </button>
            ))}
          </motion.div>
