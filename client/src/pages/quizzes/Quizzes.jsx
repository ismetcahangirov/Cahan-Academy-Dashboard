  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Quizlər</h1>
          <p className="text-gray-400 mt-1">
            Biliklərinizi yoxlamaq üçün testlər
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  ...
                  <span>Qrup: {quiz.group?.name || 'Bilinmir'}</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  <Clock size={16} className="text-bordo" />
                  <span>Müddət: {quiz.timeLimit} dəqiqə</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  <HelpCircle size={16} className="text-bordo" />
                  <span>Suallar: {quiz.questions?.length || 0}</span>
                </div>
              </div>
                ...
                {user.role === 'student' ? (
                  ...
                  <div className="flex items-center justify-between w-full">
                    <div className="text-sm text-gray-400">
                      <span className="text-white font-medium">{quiz.attempts?.length || 0}</span> cəhd
                    </div>
